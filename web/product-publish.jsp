        ...
        <section class="publish-layout" aria-label="发布商品内容">
            <section class="publish-card">
                ...
                <form class="publish-form" data-product-publish novalidate>
                    ...
                    <div class="publish-hint"><span class="publish-hint__icon">✦</span><p><strong>发布后即可展示</strong><br><span>当前普通用户版本不经过管理员审核，接口会将商品直接设为在售。</span></p></div>
            ...
            <aside class="publish-aside">
                <div class="publish-preview-card">
                    ...
                    <div class="publish-preview-visual"><span class="publish-preview-visual__emoji">✿</span><span class="publish-preview-visual__hint">校园二手好物</span></div>
